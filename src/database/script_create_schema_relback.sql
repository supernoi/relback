...
CREATE TABLESPACE "TBS_RELBACK" DATAFILE '+DATA' SIZE 256M AUTOEXTEND ON NEXT 128M MAXSIZE 10240M 
...
GRANT CREATE MATERIALIZED TO RELBACK;
...
CREATE MATERIALIZED VIEW "RELBACK"."MV_RMAN_BACKUP_JOB_DETAILS" ("DB_NAME",
...
CREATE MATERIALIZED VIEW "RELBACK"."MV_RMAN_BACKUP_SUBJOB_DETAILS" (
...
CREATE MATERIALIZED VIEW "RELBACK"."MV_RMAN_OUTPUT" ("DB_KEY",
